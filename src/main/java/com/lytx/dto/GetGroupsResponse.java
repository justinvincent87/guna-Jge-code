...
public class GetGroupsResponse implements java.io.Serializable {
	...
	public GetGroupsResponse(java.lang.Boolean error, com.lytx.dto.GroupInfo[] groups, java.lang.String message) {
		this.error		= error;
		this.groups		= groups;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals			= true
		        ...
		        && ((this.groups == null && other.getGroups() == null)
		                || (this.groups != null && java.util.Arrays.equals(this.groups, other.getGroups())))
	...
	public synchronized int hashCode() {
		...
		if (getGroups() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getGroups()); i++) {
