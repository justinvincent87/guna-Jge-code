...
public class GetVehicleStatusesResponse implements java.io.Serializable {
	...
	public GetVehicleStatusesResponse(java.lang.Boolean error, java.lang.String message,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof GetVehicleStatusesResponse))
			return false;
	...
	public synchronized int hashCode() {
		...
		if (getVehicleStatuses() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getVehicleStatuses()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
	        GetVehicleStatusesResponse.class, true);
