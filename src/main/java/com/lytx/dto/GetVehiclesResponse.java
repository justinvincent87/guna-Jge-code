...
public class GetVehiclesResponse implements java.io.Serializable {
	...
	public GetVehiclesResponse(java.lang.Boolean error, java.lang.String message, com.lytx.dto.VehicleInfo[] vehicles) {
		this.error		= error;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals			= true
		        ...
		        && ((this.vehicles == null && other.getVehicles() == null)
		                || (this.vehicles != null && java.util.Arrays.equals(this.vehicles, other.getVehicles())));
		__equalsCalc	= null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVehicles() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getVehicles()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
	        GetVehiclesResponse.class, true);
